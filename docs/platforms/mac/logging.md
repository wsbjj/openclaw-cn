...
## Enable for Clawdbot (`com.openclaw`)
- Write the plist to a temp file first, then install it atomically as root:

```bash
cat <<'EOF' >/tmp/com.openclaw.plist
...
EOF
sudo install -m 644 -o root -g wheel /tmp/com.openclaw.plist /Library/Preferences/Logging/Subsystems/com.openclaw.plist
```
...
- Remove the override: `sudo rm /Library/Preferences/Logging/Subsystems/com.openclaw.plist`.
