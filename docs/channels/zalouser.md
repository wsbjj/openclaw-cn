...
- Install via CLI: `openclaw-cn plugins install @clawdbot/zalouser`
- Or from a source checkout: `openclaw-cn plugins install ./extensions/zalouser`
...
Approve via:
- `openclaw-cn pairing list zalouser`
- `openclaw-cn pairing approve zalouser <code>`
...
- Re-login: `openclaw-cn channels logout --channel zalouser && openclaw-cn channels login --channel zalouser`
